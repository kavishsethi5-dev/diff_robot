...
class diff_PID(Node):
    ...
    def __init__(self):
        ...
        #These values can be further tuned 
        self.kp = 1.2
        self.ki= 0.01
        self.kd = 0.05
        ...
        #for timestep the value can be found in gazebo physics
    ...
    def target_callback(self, FMAmsg):
        # PoseStamped also can be used for this purpose
        #we are getting this FMAmsg from a terminal or another node(in our case)
